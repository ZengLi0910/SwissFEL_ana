...
exp.save_prefix = 'testCM_' # prefix for the saved step files


""" ------------------------- Analysis parameters ------------------------- """
step = None # number of bins (steps) to be analyzed
bins = None # bins for the scan motor. If none the motor position are used
use_stepfile = 0 # Set to 0 to reanalyze the images and rewrite the step files


useJF = [0,1,0] # perform the analysis of the relevant JF: [scatt, fluo, stripsel]
